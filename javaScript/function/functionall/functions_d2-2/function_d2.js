...
function isSymmetrical(number){
  let str=number+"";
  let RevNumber= str.split(``).reverse().join("");
   if(number==RevNumber) { console.log (true)}
  else {console.log (false)};
  } 
...
function hackerSpeak(input){
  ...
  for (var i = 0; i < input.length; i++) {
    if      (input[i] === "a") {output = output + "4";} 
    else if (input[i] === "e") {output = output + "3"; }
    else if (input[i] === "i") {output = output + "1";  } 
    else if (input[i] === "o") {output = output + "0";  } 
    else if (input[i] === "s") {output = output + "5";  } 
