...
//console.clear();
function firstFunction(){console.log(1);}
function secondFunction(){console.log(2);}
firstFunction();
secondFunction();

function firstFunction1(){setTimeout(function()
    {console.log("firstFunction1:",1);, 1000)  }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          );}
firstFunction1();
function firstFunction2(){console.log("firstFunction2:",2)
firstFunction2();
//firstFunction2():2
//firstFunction1():1

function funcToBeCalled(name){console.log("I was called by",name)}
function funcWithCallback(callback){console.log("I am funcWithCalled",name);
callback(1)
}
//1
funcWithCalled(funcToBeCalled);
// I  am funcWithCallback;
